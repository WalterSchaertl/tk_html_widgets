...
class HTMLTextParser(HTMLParser):
    ...
    def handle_starttag(self, tag, attrs):
        ...
        if tag in HTML.STYLE_TAGS:
            ...
            elif tag == HTML.Tag.SUB:
                self._stack_add(tag, WCfg.OFFSET, -6)
            elif tag == HTML.Tag.SUP:
                self._stack_add(tag, WCfg.OFFSET, 6)
    ...
    def handle_endtag(self, tag):
        ...
        if tag in HTML.STYLE_TAGS:
            ...
            elif tag in (HTML.Tag.SUP, HTML.Tag.SUB):
                self._stack_pop(tag, WCfg.OFFSET)
